...
angular.module('md-table-pagination.html', []).run(['$templateCache', function($templateCache) {
  $templateCache.put('md-table-pagination.html',
    ...
    '  <div><b>{{$pagination.label.page}}</b></div>\n' +
    '\n' +
    ...
    '  <div><b>{{$pagination.label.rowsPerPage}}</b></div>\n' +
    '\n' +
    ...
    '\n' +
    '<div class="buttons">\n' +
    '  <div style="margin-right: 20px"><b>{{$pagination.min()}} - {{$pagination.max()}} {{$pagination.label.of}} {{$pagination.total}}</b></div>\n' +
    '\n' +
...
function mdTablePagination() {
  ...
  function Controller($attrs, $mdUtil, $scope) {
    ...
    var defaultLabel = {
      page: 'Halaman:',
      rowsPerPage: 'Jumlah ditampilkan:',
      of: 'dari'
    };
